...
func TestAWG3ClientConf_HasHPK(t *testing.T) {
	...
	EnsureInboundAWGMaterial(ib, preset)
	mat := InboundAWGObfsMaterial(ib)
	conf := renderAWGQuickConf("1.2.3.4", 51841, "CLIENTPRIV", "SERVERPUB", "10.8.0.2/32", &preset, mat)
	...
	conf2 := renderAWGQuickConf("1.2.3.4", 51841, "CLIENTPRIV", "SERVERPUB", "10.8.0.2/32", &preset, InboundAWGObfsMaterial(ib2))
